sap.ui.define([
	...
	return BaseController.extend("com.sample.office.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("ZCPDB_OFFICE_TP", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("ZCPDB_OFFICE_TP", oData);
