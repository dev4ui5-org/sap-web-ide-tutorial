...
sap.ui.define([
	...
	return BaseController.extend("com.sample.office.controller.Detail", {
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("ZCPDB_OFFICE_TP", oParameter);
