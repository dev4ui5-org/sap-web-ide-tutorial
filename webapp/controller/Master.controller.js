/*global history */
sap.ui.define([
	"com/sample/office/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/sample/office/model/formatter",
	"sap/m/MessageBox"
], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("com.sample.office.controller.Master", {
				...
				function (mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							officeuuid: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("officeuuid"))
						}, true);
					}
				}.bind(this),
				function (mParams) {
		...
		_showDetail: function (oItem) {
			...
			this.getRouter().navTo("object", {
				officeuuid: encodeURIComponent(oItem.getBindingContext().getProperty("officeuuid"))
			}, bReplace);
		},
